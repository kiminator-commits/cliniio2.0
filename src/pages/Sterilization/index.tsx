    ...
    <div className="flex min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      ...
      <div className="flex-1">
        ...
        <div className="mb-6" style={{ marginLeft: drawerOpen ? 24 : 0, marginTop: 24 }}>
          <h1 className="text-2xl md:text-3xl font-bold text-[#5b5b5b] mb-2">Sterilization Management</h1>
          <p className="text-sm text-gray-500 mb-4">Manage your sterilization processes and equipment</p>
        </div>
