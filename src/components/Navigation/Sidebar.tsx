  ...
  return (
    <div className="w-64 h-screen bg-gray-100 p-4">
      ...
      <nav className="space-y-2">
        ...
        <Link href="/Sterilization" className="flex items-center space-x-2">
          <MdiIcon path={mdiSterilization} size={1} />
          <span>Sterilization</span>
        </Link>
        <Link href="/EnvironmentalCleaning" className="flex items-center space-x-2">
          <MdiIcon path={mdiSpray} size={1} />
          <span>Environmental Cleaning</span>
        </Link>
        <Link href="/KnowledgeHub" className="flex items-center space-x-2">
