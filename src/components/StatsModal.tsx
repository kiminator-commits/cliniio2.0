          ...
          >
            ...
            <div className="space-y-4">
              <div className="bg-[#4ECDC4] bg-opacity-10 p-4 rounded-xl">
                ...
                <div className="text-3xl font-bold text-[#4ECDC4]">{gamificationData.stats.toolsSterilized}</div>
              ...
              <div className="bg-blue-50 p-4 rounded-xl">
                ...
                <div className="text-3xl font-bold text-blue-700">{gamificationData.stats.inventoryChecks}</div>
              ...
              <div className="bg-green-50 p-4 rounded-xl">
                ...
                <div className="text-3xl font-bold text-green-700">{gamificationData.stats.perfectDays}</div>
              ...
              <div className="bg-purple-50 p-4 rounded-xl">
                ...
                <div className="text-3xl font-bold text-purple-700">
                  {Math.round((gamificationData.stats.completedTasks / gamificationData.stats.totalTasks) * 100)}%
                </div>
                <div className="text-xs text-purple-500 mt-1">
                  {gamificationData.stats.completedTasks} / {gamificationData.stats.totalTasks} tasks completed
                </div>
              </div>

              <div className="bg-amber-50 p-4 rounded-xl">
                <div className="mb-1 text-amber-600 font-semibold">Current Streak</div>
                <div className="text-3xl font-bold text-amber-700">{gamificationData.stats.currentStreak}</div>
